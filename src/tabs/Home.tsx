      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <View style={styles.userInfo}>
            <Image
              source={{ uri: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/148380a44d57cc7efcc92023de6ed6d5007efe99.jpg-Ee3F4IckYQTXlqw16FxK7RHE7XJlR9.jpeg' }}
          ...
          <View style={styles.popularServiceTabs}>
            {serviceCategories.map((category) => (
              <TouchableOpacity
                ...
                style={[
                  styles.tab,
                  activeServiceTab === category && styles.activeTab,
                ]}
