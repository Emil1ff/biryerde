...
const AllServices = ({ navigation }: any) => {
  ...
  const renderServiceItem = ({ item }: { item: ServiceCategory }) => (
    <TouchableOpacity
      ...
      onPress={() => navigation.navigate('ServiceDetail', { serviceId: service.id })} // Navigate to ServiceListByCategoryScreen
    >
      ...
      <View style={styles.serviceInfo}>
        ...
        <Text style={styles.providerCount}>{item.providersCount} providers</Text>
      </View>
