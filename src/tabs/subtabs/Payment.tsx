...
interface PaymentMethod {
  ...
  name: string
  icon: string
  iconType?: "ionicon" | "material-community" // Added iconType for flexibility
  lastDigits?: string
  connected: boolean
  color: string
}
...
const styles = StyleSheet.create({
  ...
  connectedButton: {
    backgroundColor: "rgba(16, 185, 129, 0.2)", // Greenish background
    borderRadius: 20,
  ...
  connectButton: {
    backgroundColor: "rgba(139, 92, 246, 0.2)", // Purple background
    borderRadius: 20,
    paddingHorizontal: 12,
    paddingVertical: 6,
  },
