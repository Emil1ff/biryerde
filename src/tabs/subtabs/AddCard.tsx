...
const AddCard: React.FC<any> = ({ navigation }) => {
  ...
  const handleAddNewCard = () => {
    // Implement logic to add new card
    console.log("Adding New Card:", { cardNumber, cardName, expiryDate, cvv })
    navigation.goBack() // Go back after adding card
  }

  // Extract last 4 digits for display on the card image
...
const styles = StyleSheet.create({
  ...
  cardPreview: {
    ...
    padding: 24,
    marginBottom: 30,
    aspectRatio: 1.6, // Standard credit card aspect ratio
    justifyContent: "space-between",
  },
  cardHeader: {
    flexDirection: "row",
