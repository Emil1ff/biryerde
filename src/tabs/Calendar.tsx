...
const CalendarDayItem: React.FC<{ item: CalendarDay; onPress: (day: CalendarDay) => void }> = ({ item, onPress }) => {
  return (
    <TouchableOpacity
      style={[
        styles.calendarDay,
...
const ScheduledServiceCard: React.FC<{ item: ScheduledService }> = ({ item }) => {
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.calendarCard}>
          <View style={styles.monthNavigation}>
            <TouchableOpacity style={styles.navButton} onPress={() => navigateMonth("prev")}>
              <MaterialCommunityIcons name="chevron-left" size={24} color="#E0E0E0" />
            </TouchableOpacity>
        ...
        <View style={styles.scheduledServicesSection}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Service Booking ({displayedServices.length})</Text>
            <TouchableOpacity>
          ...
          {displayedServices.length > 0 ? (
            <FlatList
              ...
              renderItem={({ item }) => <ScheduledServiceCard item={item} />}
            ...
            <View style={styles.emptySchedule}>
              <MaterialCommunityIcons name="clipboard-text-off" size={80} color="rgba(255, 255, 255, 0.2)" style={styles.emptyScheduleIcon} />
              <Text style={styles.emptyScheduleTitle}>You have no service booking</Text>
