        ...
        return (
          <>
            ...
            >
              ...
              {selectedContact === "sms" && (
                <Ionicons name="checkmark-circle" size={24} color="#8B5CF6" style={styles.checkmarkIcon} />
              )}
            </TouchableOpacity>
          ...
          <>
            ...
            <View style={styles.inputContainer}>
              <View style={styles.passwordInputWrapper}>
                <Feather name="lock" size={20} color="rgba(255, 255, 255, 0.6)" style={styles.passwordIcon} />
                <TextInput
                ...
                <TouchableOpacity onPress={() => setShowNewPassword(!showNewPassword)} style={styles.eyeButton}>
                  <Feather name={showNewPassword ? "eye-off" : "eye"} size={20} color="rgba(255, 255, 255, 0.6)" />
                </TouchableOpacity>
              </View>
            </View>
            ...
            <View style={styles.inputContainer}>
              <View style={styles.passwordInputWrapper}>
                ...
                <TouchableOpacity onPress={() => setShowConfirmPassword(!showConfirmPassword)} style={styles.eyeButton}>
                  <Feather name={showConfirmPassword ? "eye-off" : "eye"} size={20} color="rgba(255, 255, 255, 0.6)" />
                </TouchableOpacity>
              </View>
            </View>
